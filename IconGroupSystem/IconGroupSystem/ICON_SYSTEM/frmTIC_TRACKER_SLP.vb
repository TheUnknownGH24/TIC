...
Public Class frmTIC_TRACKER_SLP
    ...
    Private Sub txtSUPPLIERNAME_TextChanged(sender As Object, e As EventArgs) Handles txtREFERENCE.TextChanged
        ...
        DataGridView2.Rows.Clear()
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_requestslip where `controlno` like '%" & txtREFERENCE.Text & "%'", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub frmTIC_TRACKER_SLP_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
