Public Class frm8SI_CASHADVANCE_RECORD
    ...
    Sub LoadCAList()
        ...
        ElseIf txtDEP.Text = "DRS - ADMIN" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where `department` like 'DIRECT SELLING - OPERATIONS' OR `department` like 'DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)' OR `department` like 'DIRECT SELLING - OPERATIONS - (MINDANAO)' OR `department` like 'DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)' OR `department` like 'DIRECT SELLING - OPERATIONS - (VISAYAS)' ", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where employee like '%" & txtNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where `department` like '%" & txtDEPARTMENTDATA.Text & "%' ", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Or txtDEPARTMENTDATA.Text = "FINANCE DEPARTMENT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where ca_no like '%" & TextBox1.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where employee like '%" & txtNAME.Text & "%' AND ca_no like '%" & TextBox1.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        Else
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where ca_no like '%" & TextBox1.Text & "%' and `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub frm8SI_CASHADVANCE_RECORD_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
