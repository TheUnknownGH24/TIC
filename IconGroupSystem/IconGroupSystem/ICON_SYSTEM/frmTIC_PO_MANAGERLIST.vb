...
Public Class frmTIC_PO_MANAGERLIST
    ...
    Private Sub frmTIC_PO_MANAGERLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
