Public Class frmTIC_PR_COO_FORM_VIEW
    ...
    Private Sub frmTIC_PR_COO_FORM_VIEW_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
