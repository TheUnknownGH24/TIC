...
Public Class frmTIC_TRACKER_PR
    ...
    Private Sub txtSUPPLIERNAME_TextChanged(sender As Object, e As EventArgs) Handles txtREFERENCE.TextChanged
        ...
        DataGridView2.Rows.Clear()
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where `pr_no` like '%" & txtREFERENCE.Text & "%'", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub frmTIC_TRACKER_PR_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
