...
Public Class frm8SI_PR_REQUEST_LIST
    ...
    Private Sub txtSEARCHNAME_TextChanged(sender As Object, e As EventArgs) Handles txtSEARCHNAME.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_requestslip where `controlno` like '%" & txtSEARCHNAME.Text & "%' AND `manager_approval` = 'APPROVED' AND `gm_approval` = 'APPROVED' AND `status` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub frm8SI_PR_REQUEST_LIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
