Public Class frmTIC_PR_MANAGER_FORM_VIEW
    ...
    Sub LoadPURCHASEDList_supplier1_FINAL()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequestlist where `pr_no` like '" & txtPRNO_1.Text & "'  AND `supplier_name` like '" & txtSUPPLIER_1.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read
    ...
    Sub LoadPURCHASEDList_supplier2_FINAL()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequestlist where `pr_no` like '" & txtPRNO_2.Text & "'  AND `supplier_name` like '" & txtSUPPLIER_2.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read
    ...
    Sub LoadPURCHASEDList_supplier3_FINAL()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequestlist where `pr_no` like '" & txtPRNO_3.Text & "'  AND `supplier_name` like '" & txtSUPPLIER_3.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read
    ...
    Private Sub frmTIC_PR_MANAGER_FORM_VIEW_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
