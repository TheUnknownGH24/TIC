Public Class frmWAREHOUSE_DR_SUPERVISOR
    ...
    Sub LoadDRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_dr where `supervisor_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_dr where dr_no like '%" & TextBox1.Text & "%' AND `supervisor_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Try
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_warehouse_dr set supervisor_name=@supervisor_name, supervisor_approval=@supervisor_approval, supervisor_comment=@supervisor_comment, status=@status where id=@id", cn)
                ...
                MsgBox("Delivery Receipt has been Successfully Approved!", vbInformation + vbOKOnly, "CONFIRMATION")
    ...
    Private Sub frmWAREHOUSE_DR_SUPERVISOR_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
