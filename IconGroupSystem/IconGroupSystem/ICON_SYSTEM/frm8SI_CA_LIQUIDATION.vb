Public Class frm8SI_CA_LIQUIDATION
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where ca_no like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'RELEASED'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtNAME.Text = "DEV-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "OPS-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "BC-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "DEV-KAMILLE ANN M. ESPIRITU" Or txtNAME.Text = "OPS-KAMILLE ANN M. ESPIRITU" Or txtNAME.Text = "BC-KAMILLE ANN M. ESPIRITU" Then


            DataGridView2.Rows.Clear()
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where ca_no like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'RELEASED' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where employee like '%" & txtNAME.Text & "%' AND ca_no like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'RELEASED'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadCAList()
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'RELEASED' ", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtNAME.Text = "DEV-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "OPS-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "BC-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "DEV-KAMILLE ANN M. ESPIRITU" Or txtNAME.Text = "OPS-KAMILLE ANN M. ESPIRITU" Or txtNAME.Text = "BC-KAMILLE ANN M. ESPIRITU" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'RELEASED' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%' ", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance where employee like '%" & txtNAME.Text & "%' AND `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'RELEASED' ", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("INSERT into tbl_8si_cashadvance_liquidation (ca_no, date, employee, department, depcode, purpose, total_caamount, total_liquidation, total_balance, endorsed_approval, finance_approval, final_approval, date_time, status, endorsed_comment, finance_comment, final_comment) values(@ca_no, @date, @employee, @department, @depcode, @purpose, @total_caamount, @total_liquidation, @total_balance, @endorsed_approval, @finance_approval, @final_approval, @date_time, @status, @endorsed_comment, @finance_comment, @final_comment)", cn)
            With cm.Parameters
    ...
    Sub CA_UPDATE()
        ...
        cn.Open()
        cm = New MySqlCommand("Update tbl_8si_cashadvance set status=@status where id=@id", cn)
    ...
    Sub DisplayCANO()
        ...
        cn.Open()
        adp = New MySqlDataAdapter("select * from tbl_8si_cashadvance_liquidation where `ca_no` = '" & txtREFERENCE.Text & "' ORDER BY id DESC LIMIT 1", cn)
        dt = New DataTable
        adp.Fill(dt)
    ...
    Sub SaveInCAList()
        ...
        For Each row As DataGridViewRow In dataGridView1.Rows
            ...
            cm = New MySqlCommand("INSERT into tbl_8si_cashadvance_liquidationlist (cano_liquidation, expense_categories, date_of_receipt, supplier_name, receipt_no, receipt_amount, remarks) values(@cano_liquidation, @expense_categories, @date_of_receipt, @supplier_name, @receipt_no, @receipt_amount, @remarks)", cn)
            With cm.Parameters
    ...
    Private Sub frm8SI_CA_LIQUIDATION_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
