Public Class frmWAREHOUSE_SRS_HR
    ...
    Sub LoadIPRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_srs where `manager_approval` = 'APPROVED' AND `final_approval` = 'FOR APPROVAL' AND `releaser_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_srs where srs_no like '%" & TextBox1.Text & "%' AND `manager_approval` = 'APPROVED' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' AND `releaser_approval` = 'FOR APPROVAL' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Try
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_warehouse_srs set final_name=@final_name, final_approval=@final_approval, final_comment=@final_comment, status=@status where id=@id", cn)
                ...
                With cm.Parameters
                    ...
                    .AddWithValue("@final_comment", txtHRCOMMENT.Text & "-" & DateTimePicker1.Value)
    ...
    Private Sub btnPRINT_Click(sender As Object, e As EventArgs) Handles btnPRINT.Click
        ...
        Try
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_warehouse_srs set manager_approval=@manager_approval, final_name=@final_name, final_approval=@final_approval, final_comment=@final_comment, status=@status where id=@id", cn)
