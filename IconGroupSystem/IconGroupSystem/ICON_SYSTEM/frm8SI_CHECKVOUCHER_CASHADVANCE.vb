Public Class frm8SI_CHECKVOUCHER_CASHADVANCE
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_cashadvance where ca_no like '%" & TextBox1.Text & "%' AND `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'APPROVED BY MS.VTY'", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadCAList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_cashadvance where `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'APPROVED BY MS.VTY' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub frm8SI_CHECKVOUCHER_CASHADVANCE_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub txtCHECKVOUCHERDATE_ValueChanged(sender As Object, e As EventArgs) Handles txtCHECKVOUCHERDATE.ValueChanged
