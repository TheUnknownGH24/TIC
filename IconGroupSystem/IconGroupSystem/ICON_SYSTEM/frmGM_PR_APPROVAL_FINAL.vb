...
Public Class frmGM_PR_APPROVAL_FINAL
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tblpurchasedrequest set pr_no=@pr_no, transaction_no=@transaction_no, employee=@employee, department=@department, date=@date, purpose=@purpose, supplier_1=@supplier_1, supplier_2=@supplier_2, supplier_3=@supplier_3, GM_APPROVAL=@GM_APPROVAL, gm_comment=@gm_comment where id=@id", cn)
