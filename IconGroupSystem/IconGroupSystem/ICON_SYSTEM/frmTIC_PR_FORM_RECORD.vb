Public Class frmTIC_PR_FORM_RECORD
    ...
    Sub Supplier_sumselect()
        ...
        txtSELECT_UNIT1.Text = CDbl(TOTALUNIT_1).ToString("#,##0.00")
        txtSELECT_VAT1.Text = CDbl(VATTOTAL_1).ToString("#,##0.00")
        txtSELECT_TOTAL1.Text = CDbl(GRANDTOTAL_1).ToString("#,##0.00")

        txtSELECT_UNIT2.Text = CDbl(TOTALUNIT_2).ToString("#,##0.00")
        txtSELECT_VAT2.Text = CDbl(VATTOTAL_2).ToString("#,##0.00")
        txtSELECT_TOTAL2.Text = CDbl(GRANDTOTAL_2).ToString("#,##0.00")

        txtSELECT_UNIT3.Text = CDbl(TOTALUNIT_3).ToString("#,##0.00")
        txtSELECT_VAT3.Text = CDbl(VATTOTAL_3).ToString("#,##0.00")
        txtSELECT_TOTAL3.Text = CDbl(GRANDTOTAL_3).ToString("#,##0.00")
    ...
    Private Sub txtSEARCHNAME_TextChanged(sender As Object, e As EventArgs) Handles txtSEARCHNAME.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where `pr_no` like '%" & txtSEARCHNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
            While dr.Read
                i += 1
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where `department` like '%" & txtDEPARTMENTDATA.Text & "%' and `pr_no` like '%" & txtSEARCHNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
            While dr.Read
                i += 1
                DataGridView5.Rows.Add(i, dr.Item("id").ToString, dr.Item("pr_no").ToString, dr.Item("transaction_no").ToString, dr.Item("employee").ToString, dr.Item("department").ToString, dr.Item("date").ToString, dr.Item("purpose").ToString, dr.Item("supplier_1").ToString, dr.Item("supplier_2").ToString, dr.Item("supplier_3").ToString)
    ...
    Sub LoadPURCHASEDList()
        ...
        While dr.Read
            ...
            DataGridView4.Rows.Add(dr.Item("quantity").ToString, dr.Item("unit").ToString, dr.Item("item_name").ToString, dr.Item("supplier_1").ToString, CDbl(dr.Item("unit_price_1").ToString).ToString("#,##0.00"), dr.Item("vat_amount_1").ToString, dr.Item("total_amount_1").ToString, dr.Item("supplier_2").ToString, CDbl(dr.Item("unit_price_2").ToString).ToString("#,##0.00"), dr.Item("vat_amount_2").ToString, dr.Item("total_amount_2").ToString, dr.Item("supplier_3").ToString, CDbl(dr.Item("unit_price_3").ToString).ToString("#,##0.00"), dr.Item("vat_amount_3").ToString, dr.Item("total_amount_3").ToString, dr.Item("final_supplier").ToString)
    ...
    Sub LoadPRList()
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest", cn)
            dr = cm.ExecuteReader
            While dr.Read
                i += 1
                DataGridView5.Rows.Add(i, dr.Item("id").ToString, dr.Item("pr_no").ToString, dr.Item("transaction_no").ToString, dr.Item("employee").ToString, dr.Item("department").ToString, dr.Item("date").ToString, dr.Item("purpose").ToString, dr.Item("supplier_1").ToString, dr.Item("supplier_2").ToString, dr.Item("supplier_3").ToString)
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
            While dr.Read
                i += 1
                DataGridView5.Rows.Add(i, dr.Item("id").ToString, dr.Item("pr_no").ToString, dr.Item("transaction_no").ToString, dr.Item("employee").ToString, dr.Item("department").ToString, dr.Item("date").ToString, dr.Item("purpose").ToString, dr.Item("supplier_1").ToString, dr.Item("supplier_2").ToString, dr.Item("supplier_3").ToString)
    ...
    Sub LoadPURCHASEDList_supplier1()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest_all where `pr_no` like '" & txtCONTROL.Text & "'  AND `supplier_1` like '" & txtSUPPLIER_1.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read

                dataGridView1.Rows.Add(dr.Item("quantity").ToString, dr.Item("unit").ToString, dr.Item("item_name").ToString, CDbl(dr.Item("unit_price_1").ToString).ToString("#,##0.00"), dr.Item("vat_amount_1").ToString, dr.Item("total_amount_1").ToString)
    ...
    Sub LoadPURCHASEDList_supplier2()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest_all where `pr_no` like '" & txtCONTROL.Text & "'  AND `supplier_2` like '" & txtSUPPLIER_2.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read

                DataGridView2.Rows.Add(dr.Item("quantity").ToString, dr.Item("unit").ToString, dr.Item("item_name").ToString, CDbl(dr.Item("unit_price_2").ToString).ToString("#,##0.00"), dr.Item("vat_amount_2").ToString, dr.Item("total_amount_2").ToString)
    ...
    Sub LoadPURCHASEDList_supplier3()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest_all where `pr_no` like '" & txtCONTROL.Text & "'  AND `supplier_3` like '" & txtSUPPLIER_3.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read

                DataGridView3.Rows.Add(dr.Item("quantity").ToString, dr.Item("unit").ToString, dr.Item("item_name").ToString, CDbl(dr.Item("unit_price_3").ToString).ToString("#,##0.00"), dr.Item("vat_amount_3").ToString, dr.Item("total_amount_3").ToString)
    ...
    Private Sub DataGridView5_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView5.CellContentClick
        ...
        If colname = "MANAGER_APPROVAL" Then
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where id like '" & DataGridView5.Rows(e.RowIndex).Cells(1).Value.ToString & "'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        If txtSUPPLIER_3.Text = String.Empty Then
            ...
            Dim rect1 As New Rectangle(50, 80, 990, 25)
        ...
        For i = 0 To DataGridView3.Rows.Count - 1
            ...
            Dim supp1 As New Rectangle(1053, 220, 235, 14)
            ...
            Dim total2 As New Rectangle(1128, 235, 75, 14)
            Dim total3 As New Rectangle(1203, 235, 75, 14)

            Dim total4 As New Rectangle(1053, 250, 75, 14)
            Dim total5 As New Rectangle(1128, 250, 75, 14)
            Dim total6 As New Rectangle(1203, 250, 75, 14)
            ...
            Dim box4 As New Rectangle(1128, 270, 75, 14)
            Dim box5 As New Rectangle(1203, 270, 75, 14)
            ...
            Dim data4 As New Rectangle(1128, z, 75, 14)
            Dim data5 As New Rectangle(1203, z, 75, 14)
    ...
    Sub LoadPURCHASEDList_select1()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequestlist where `pr_no` like '" & txtCONTROL.Text & "'  AND `supplier_name` like '" & txtSUPPLIER_1.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read

                DataGridView8.Rows.Add(dr.Item("quantity").ToString, dr.Item("unit").ToString, dr.Item("item_name").ToString, CDbl(dr.Item("unit_price").ToString).ToString("#,##0.00"), dr.Item("vat_amount").ToString, dr.Item("grand_total").ToString)
    ...
    Sub LoadPURCHASEDList_select2()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequestlist where `pr_no` like '" & txtCONTROL.Text & "'  AND `supplier_name` like '" & txtSUPPLIER_2.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read

                DataGridView7.Rows.Add(dr.Item("quantity").ToString, dr.Item("unit").ToString, dr.Item("item_name").ToString, CDbl(dr.Item("unit_price").ToString).ToString("#,##0.00"), dr.Item("vat_amount").ToString, dr.Item("grand_total").ToString)
    ...
    Sub LoadPURCHASEDList_select3()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedrequestlist where `pr_no` like '" & txtCONTROL.Text & "'  AND `supplier_name` like '" & txtSUPPLIER_3.Text & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read

                DataGridView6.Rows.Add(dr.Item("quantity").ToString, dr.Item("unit").ToString, dr.Item("item_name").ToString, CDbl(dr.Item("unit_price").ToString).ToString("#,##0.00"), dr.Item("vat_amount").ToString, dr.Item("grand_total").ToString)
    ...
    Private Sub frmTIC_PR_FORM_RECORD_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
