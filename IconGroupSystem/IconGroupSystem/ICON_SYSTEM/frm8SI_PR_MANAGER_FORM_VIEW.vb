Public Class frm8SI_PR_MANAGER_FORM_VIEW
    ...
    Private Sub frm8SI_PR_MANAGER_FORM_VIEW_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
