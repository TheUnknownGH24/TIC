Public Class frmWAREHOUSE_SRS_WAREHOUSE
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("INSERT into tbl_warehouse_srs (date, transactionno, date_required, requestor, department, purpose, manager_name, manager_approval, manager_comment, final_name, final_approval, final_comment, releaser_name, releaser_approval, releaser_comment, date_time, status) values(@date, @transactionno, @date_required, @requestor, @department, @purpose, @manager_name, @manager_approval, @manager_comment, @final_name, @final_approval, @final_comment, @releaser_name, @releaser_approval, @releaser_comment, @date_time, @status)", cn)
            With cm.Parameters
