...
Public Class frmTIC_PR_RETURN_FORM_FINAL
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_tic_purchasedrequest set purpose=@purpose, status=@status where id=@id", cn)
                With cm.Parameters
    ...
    Private Sub frmTIC_PR_RETURN_FORM_FINAL_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
