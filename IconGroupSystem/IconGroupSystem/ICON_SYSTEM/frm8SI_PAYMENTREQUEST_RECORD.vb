Public Class frm8SI_PAYMENTREQUEST_RECORD
...
ElseIf txtNAME.Text = "DEV-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "OPS-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "BC-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "RACHEL MEDRANO" Or txtNAME.Text = "CHARLOTTE DAYRIT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_paymentrequest where `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_paymentrequest where employee like '%" & txtNAME.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub frm8SI_PAYMENTREQUEST_RECORD_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Or txtDEPARTMENTDATA.Text = "FINANCE DEPARTMENT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_paymentrequest where controlno like '%" & TextBox1.Text & "%'", cn)
            dr = cm.ExecuteReader
...
ElseIf txtNAME.Text = "DEV-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "OPS-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "BC-JENNALYN VALLE ALFABETE" Or txtNAME.Text = "RACHEL MEDRANO" Or txtNAME.Text = "CHARLOTTE DAYRIT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_paymentrequest where controlno like '%" & TextBox1.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_paymentrequest where employee like '%" & txtNAME.Text & "%' AND controlno like '%" & TextBox1.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_paymentrequest where controlno like '%" & TextBox1.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%' AND `supplier_name` like '%" & TextBox1.Text & "%'", cn)
            dr = cm.ExecuteReader
