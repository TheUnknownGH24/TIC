Public Class frmWAREHOUSE_RR_IPR
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_ipr where `ipr_no` like '%" & TextBox1.Text & "%' AND `STATUS` = 'ACTIVE' AND `manager_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' ", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadIPRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_ipr where `STATUS` = 'ACTIVE' AND `manager_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' ", cn)
        dr = cm.ExecuteReader
