...
Public Class frm8SI_PO_MANAGER_FORM
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_8si_purchasedorder set required_date=@required_date, MANAGER_APPROVAL=@MANAGER_APPROVAL, manager_comment=@manager_comment where id=@id", cn)
                With cm.Parameters
    ...
    Sub UpdateWarehouseArea()

        Try
            cn.Open()
            cm = New MySqlCommand("Update tbl_warehouse_po_8si set status=@status where po_no=@po_no", cn)
            With cm.Parameters
    ...
    Private Sub btnPRINT_Click(sender As Object, e As EventArgs) Handles btnPRINT.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_8si_purchasedorder set required_date=@required_date, MANAGER_APPROVAL=@MANAGER_APPROVAL, manager_comment=@manager_comment, status=@status where id=@id", cn)
                With cm.Parameters
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_purchasedorder where `po_no` like '%" & TextBox1.Text & "%' AND `MANAGER_APPROVAL` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE'", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadPOList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_purchasedorder where `MANAGER_APPROVAL` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub frm8SI_PO_MANAGER_FORM_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
