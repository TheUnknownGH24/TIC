...
Public Class frm8SI_REQUESTLIST
    ...
    Private Sub dataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dataGridView1.CellContentClick
        ...
        If colname = "colUPDATE" Then
            With frm8SI_REQUESTSLIP_MODIFY
                cn.Open()
    ...
    Private Sub frm8SI_REQUESTLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
