...
Public Class frm8SI_PO_MODIFYLIST
    ...
    Private Sub frm8SI_PO_MODIFYLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
