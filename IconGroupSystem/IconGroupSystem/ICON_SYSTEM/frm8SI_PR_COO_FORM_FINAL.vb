...
Public Class frm8SI_PR_COO_FORM_FINAL
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_8si_purchasedrequest set purpose=@purpose, COO_APPROVAL=@COO_APPROVAL, coo_comment=@coo_comment where id=@id", cn)
                With cm.Parameters
    ...
    Private Sub btnRETURN_Click(sender As Object, e As EventArgs) Handles btnRETURN.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_8si_purchasedrequest set purpose=@purpose, MANAGER_APPROVAL=@MANAGER_APPROVAL, manager_comment=@manager_comment, GM_APPROVAL=@GM_APPROVAL, gm_comment=@gm_comment, COO_APPROVAL=@COO_APPROVAL, coo_comment=@coo_comment, status=@status where id=@id", cn)
                With cm.Parameters
                    .AddWithValue("@id", txtID.Text)
                    .AddWithValue("@purpose", txtREMARKS.Text)
    ...
    Private Sub txtSEARCHNAME_TextChanged(sender As Object, e As EventArgs) Handles txtSEARCHNAME.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_purchasedrequest where pr_no like '%" & txtSEARCHNAME.Text & "%' AND `MANAGER_APPROVAL` = 'APPROVED' AND `GM_APPROVAL` = 'APPROVED' and `COO_APPROVAL` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE'", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadPRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_purchasedrequest where `MANAGER_APPROVAL` = 'APPROVED' and `GM_APPROVAL` = 'APPROVED' and `COO_APPROVAL` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        frm8SI_PR_COO_FORM_VIEW.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text
        frm8SI_PR_COO_FORM_VIEW.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text
        frm8SI_PR_COO_FORM_VIEW.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text

        frm8SI_PR_COO_FORM_VIEW.txtPRNO_1.Text = txtCONTROL.Text
        frm8SI_PR_COO_FORM_VIEW.txtPRNO_2.Text = txtCONTROL.Text
        frm8SI_PR_COO_FORM_VIEW.txtPRNO_3.Text = txtCONTROL.Text

        frm8SI_PR_COO_FORM_VIEW.LoadPURCHASEDList_supplier1_FINAL()
        frm8SI_PR_COO_FORM_VIEW.LoadPURCHASEDList_supplier2_FINAL()
        frm8SI_PR_COO_FORM_VIEW.LoadPURCHASEDList_supplier3_FINAL()

        frm8SI_PR_COO_FORM_VIEW.Supplier_sum()

        frm8SI_PR_COO_FORM_VIEW.StartPosition = FormStartPosition.CenterScreen
        frm8SI_PR_COO_FORM_VIEW.Show()


    End Sub

    Private Sub frm8SI_PR_COO_FORM_FINAL_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
