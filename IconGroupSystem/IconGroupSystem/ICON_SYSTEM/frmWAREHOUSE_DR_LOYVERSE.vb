...
Public Class frmWAREHOUSE_DR_LOYVERSE
    ...
    Sub Save_Data()
        ...
        For Each row As DataGridViewRow In DataGridView2.Rows
            ...
            With cm.Parameters
                ...
                .AddWithValue("@date", row.Cells("Date").Value)
    ...
    Private Sub frmWAREHOUSE_DR_LOYVERSE_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Sub REMOVE_DUPLICATE()
        ...
        For i As Integer = DataGridView2.Rows.Count - 1 To 0 Step -1
            ...
            Dim value As String = row.Cells("Receipt_number").Value.ToString()
    ...
    Sub REMOVE_CANCEL_1()
        ...
        For Each row As DataGridViewRow In DataGridView1.Rows
            ...
            If Not row.IsNewRow AndAlso row.Cells(21).Value IsNot Nothing AndAlso row.Cells(21).Value.ToString() = "Cancelled" Then
