...
Public Class frm8SI_PO_COOLIST
    ...
    Sub Add_Approval_Button()
        ...
        End With
        dataGridView1.Columns.Insert(14, colApproval)
    ...
    Private Sub frm8SI_PO_COOLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
