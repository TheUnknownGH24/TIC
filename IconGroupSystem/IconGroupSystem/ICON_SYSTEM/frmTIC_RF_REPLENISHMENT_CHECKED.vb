Public Class frmTIC_RF_REPLENISHMENT_CHECKED
    ...
    Sub Add_Approval_Button()
        ...
        End With
        DataGridView2.Columns.Insert(16, colApproval)
    ...
    Sub LoadRFList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_rf_replenishment where `endorsed_approval` = 'APPROVED' AND `reviewed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("Update tbl_tic_rf_replenishment set reviewed_approval=@reviewed_approval, reviewed_comment=@reviewed_comment, status=@status where id=@id", cn)

            With cm.Parameters

                .AddWithValue("@id", txtID.Text)

                .AddWithValue("@reviewed_approval", "APPROVED")
                .AddWithValue("@reviewed_comment", txtCHECK.Text & "-" & DateTimePicker1.Value)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("Update tbl_tic_rf_replenishment set endorsed_approval=@endorsed_approval, reviewed_approval=@reviewed_approval, reviewed_comment=@reviewed_comment, status=@status where id=@id", cn)
            ...
            With cm.Parameters
                ...
                .AddWithValue("@reviewed_approval", "FOR APPROVAL")
                .AddWithValue("@reviewed_comment", txtCHECK.Text & "-" & DateTimePicker1.Value)
            ...
            MsgBox("RF Replenishment has been Successfully Return!", vbInformation + vbOKOnly, "CONFIRMATION")
    ...
    Private Sub frmTIC_RF_REPLENISHMENT_CHECKED_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        With frmPURPOSE
            ...
            .txtSHOWPURPOSE.Text = txtCHECK.Text
            .ShowDialog()
