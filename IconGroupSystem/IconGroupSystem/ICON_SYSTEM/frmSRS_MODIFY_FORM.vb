...
Public Class frmSRS_MODIFY_FORM
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("Update tblsrs_request set date_needed=@date_needed, modified_date=@modified_date where id=@id", cn)
            ...
            With cm.Parameters
                ...
                .AddWithValue("@modified_date", DateTimePicker1.Value)
    ...
    Sub SaveInSRSList()
        ...
        For Each row As DataGridViewRow In dataGridView1.Rows
            ...
            cn.Close()
        Next
        MsgBox("Supply Requisition has been Successfully Saved!", vbInformation + vbOKOnly, "CONFIRMATION")
