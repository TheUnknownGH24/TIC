Public Class frmTIC_PR_GM_FORM_VIEW
    ...
    Private Sub frmTIC_PR_GM_FORM_VIEW_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
