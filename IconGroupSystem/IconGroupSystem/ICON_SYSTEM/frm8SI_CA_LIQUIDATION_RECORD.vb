Public Class frm8SI_CA_LIQUIDATION_RECORD
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Or txtDEPARTMENTDATA.Text = "FINANCE DEPARTMENT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance_liquidation where `cano_liquidation` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance_liquidation where employee like '%" & txtNAME.Text & "%' AND `cano_liquidation` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance_liquidation where `cano_liquidation` like '%" & TextBox3.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadCAList()
        ...
        ElseIf txtDEP.Text = "DRS - ADMIN" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance_liquidation where `department` like 'DIRECT SELLING - OPERATIONS' OR `department` like 'DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)' OR `department` like 'DIRECT SELLING - OPERATIONS - (MINDANAO)' OR `department` like 'DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)' OR `department` like 'DIRECT SELLING - OPERATIONS - (VISAYAS)'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance_liquidation where employee like '%" & txtNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_cashadvance_liquidation where `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub frm8SI_CA_LIQUIDATION_RECORD_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub frm8SI_CA_LIQUIDATION_RECORD_Load(sender As Object, e As EventArgs) Handles MyBase.Load
