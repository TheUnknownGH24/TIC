...
Public Class frmCOO_PR_APPROVAL
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Try
            If MsgBox("Do you want to Exit ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                frmCOO_PR_APPROVAL_LIST.LoadPRList()
                Me.Dispose()
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        frmCOO_PR_APPROVAL_FINAL.txtID.Text = txtID.Text
        frmCOO_PR_APPROVAL_FINAL.txtCONTROL.Text = txtCONTROL.Text
        frmCOO_PR_APPROVAL_FINAL.txtEMPLOYEE.Text = txtEMPLOYEE.Text
        frmCOO_PR_APPROVAL_FINAL.txtDEPARTMENT.Text = txtDEPARTMENT.Text
        frmCOO_PR_APPROVAL_FINAL.txtDATE.Text = txtDATE.Text
        frmCOO_PR_APPROVAL_FINAL.txtTRANSACTION.Text = txtTRANSACTION.Text
        frmCOO_PR_APPROVAL_FINAL.txtREMARKS.Text = txtREMARKS.Text

        frmCOO_PR_APPROVAL_FINAL.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text

        frmCOO_PR_APPROVAL_FINAL.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text

        frmCOO_PR_APPROVAL_FINAL.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text

        frmCOO_PR_APPROVAL_FINAL.LoadSupplier_1()
        frmCOO_PR_APPROVAL_FINAL.LoadSupplier_2()
        frmCOO_PR_APPROVAL_FINAL.LoadSupplier_3()

        frmCOO_PR_APPROVAL_FINAL.StartPosition = FormStartPosition.CenterScreen
        frmCOO_PR_APPROVAL_FINAL.ShowDialog()
