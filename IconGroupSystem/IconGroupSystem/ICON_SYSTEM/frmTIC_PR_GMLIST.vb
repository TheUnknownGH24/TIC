...
Public Class frmTIC_PR_GMLIST
        ...
        If colname = "MANAGER_APPROVAL" Then
            With frmTIC_PR_GM_FORM
                ...
                While dr.Read
                    ...
                    .txtCOMMENT.Text = dataGridView1.Rows(e.RowIndex).Cells(11).Value.ToString
    ...
    Private Sub frmTIC_PR_GMLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
