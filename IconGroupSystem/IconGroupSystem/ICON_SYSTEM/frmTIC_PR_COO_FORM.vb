...
Public Class frmTIC_PR_COO_FORM
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        frmTIC_PR_COO_FORM_FINAL.txtID.Text = txtID.Text
        frmTIC_PR_COO_FORM_FINAL.txtMANAGERCOMMENT.Text = txtMANAGERCOMMENT.Text
        frmTIC_PR_COO_FORM_FINAL.txtGMCOMMENT.Text = txtGMCOMMENT.Text
        frmTIC_PR_COO_FORM_FINAL.txtID.Text = txtID.Text
        frmTIC_PR_COO_FORM_FINAL.txtCONTROL.Text = txtCONTROL.Text
        frmTIC_PR_COO_FORM_FINAL.txtEMPLOYEE.Text = txtEMPLOYEE.Text
        frmTIC_PR_COO_FORM_FINAL.txtDEPARTMENT.Text = txtDEPARTMENT.Text
        frmTIC_PR_COO_FORM_FINAL.txtDATE.Text = txtDATE.Text
        frmTIC_PR_COO_FORM_FINAL.txtTRANSACTION.Text = txtTRANSACTION.Text
        frmTIC_PR_COO_FORM_FINAL.txtREMARKS.Text = txtREMARKS.Text

        frmTIC_PR_COO_FORM_FINAL.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text

        frmTIC_PR_COO_FORM_FINAL.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text

        frmTIC_PR_COO_FORM_FINAL.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text
        ...
        For Each row_1 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frmTIC_PR_COO_FORM_FINAL.dataGridView1.DataSource = dt_1
        ...
        For Each row_2 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frmTIC_PR_COO_FORM_FINAL.DataGridView2.DataSource = dt_2
        ...
        For Each row_3 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frmTIC_PR_COO_FORM_FINAL.DataGridView3.DataSource = dt_3
        ...
        frmTIC_PR_COO_FORM_FINAL.Supplier_sum()
        frmTIC_PR_COO_FORM_FINAL.StartPosition = FormStartPosition.CenterParent
        frmTIC_PR_COO_FORM_FINAL.ShowDialog()
    ...
    Private Sub frmTIC_PR_COO_FORM_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
