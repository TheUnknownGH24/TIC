...
Public Class frmTIC_PR_MODIFY_ADDSUPPLIER_3
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        frmTIC_PR_MODIFY_FORM.txtSUPPLIER_3.Text = txtSEARCHNAME.Text
        Dispose()
    ...
    Private Sub frmTIC_PR_MODIFY_ADDSUPPLIER_3_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
