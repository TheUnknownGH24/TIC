...
Public Class frm8SI_PR_ADDSUPPLIER_1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            ...
            frm8SI_PR_FORM.txtSUPPLIER_1.Text = txtSEARCHNAME.Text
            Dispose()
    ...
    Private Sub frm8SI_PR_ADDSUPPLIER_1_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
