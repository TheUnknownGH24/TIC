Public Class frmVIEW_TIC_REIMBURSEMENT_FINANCE
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%' AND `endorsed_approval` = APPROVED' AND `finance_approval` = 'FOR APPROVAL' OR `finance_approval` = 'APPROVED' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE'", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadREIMList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_reimbursement where `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'FOR APPROVAL' OR `finance_approval` = 'APPROVED' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub frm8SI_REIMBURSEMENT_FINANCE_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
