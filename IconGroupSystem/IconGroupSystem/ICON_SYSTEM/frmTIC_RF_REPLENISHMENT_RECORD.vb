Public Class frmTIC_RF_REPLENISHMENT_RECORD
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Or txtDEPARTMENTDATA.Text = "FINANCE DEPARTMENT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_rf_replenishment where `rf_no` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtNAME.Text = "JENNALYN VALLE ALFABETE" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_rf_replenishment where `rf_no` like '%" & TextBox3.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_rf_replenishment where employee like '%" & txtNAME.Text & "%' AND `rf_no` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadRFList()
        ...
        ElseIf txtNAME.Text = "JENNALYN VALLE ALFABETE" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_rf_replenishment where `department` like '%" & txtDEPARTMENTDATA.Text & "%' ", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_rf_replenishment where employee like '%" & txtNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub frmTIC_RF_REPLENISHMENT_RECORD_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
