Public Class frm8SI_REIMBURSEMENT_RECORD
    ...
    Sub Add_Approval_Button()
        ...
        End With
        DataGridView2.Columns.Insert(17, colApproval)
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Or txtDEPARTMENTDATA.Text = "FINANCE DEPARTMENT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEP.Text = "DRS - ADMIN" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%' AND employee like '%" & txtNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadREIMList()
        ...
        ElseIf txtDEP.Text = "DRS - ADMIN" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_reimbursement where `department` like 'DIRECT SELLING - OPERATIONS' OR `department` like 'DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)' OR `department` like 'DIRECT SELLING - OPERATIONS - (MINDANAO)' OR `department` like 'DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)' OR `department` like 'DIRECT SELLING - OPERATIONS - (VISAYAS)'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_reimbursement where `department` like '%" & txtDEPARTMENTDATA.Text & "%' AND employee like '%" & txtNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_reimbursement where `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub DataGridView2_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView2.CellContentClick
        ...
        If colname = "MANAGER_APPROVAL" Then
            ...
            While dr.Read
                ...
                txtSTATUS.Text = DataGridView2.Rows(e.RowIndex).Cells(13).Value.ToString

                txtAPPROVED1.Text = DataGridView2.Rows(e.RowIndex).Cells(14).Value.ToString
                txtAPPROVED2.Text = DataGridView2.Rows(e.RowIndex).Cells(15).Value.ToString
                txtAPPROVED3.Text = DataGridView2.Rows(e.RowIndex).Cells(16).Value.ToString
    ...
    Private Sub frm8SI_REIMBURSEMENT_RECORD_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
