Public Class frm8SI_CHECKVOUCHER_RECORD
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_checkvoucher where `cv_no` like '%" & TextBox3.Text & "%' or `supplier_name` like '%" & TextBox3.Text & "%' or `amount_due` like '%" & TextBox3.Text & "%'", cn)
        dr = cm.ExecuteReader
