Public Class frmTIC_REIMBURSEMENT_MANAGER
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadREIMList()
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" And txtDEP.Text = "DRS - VP SALES" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `endorsed_approval` = 'FOR APPROVAL' AND `department` = 'DIRECT SELLING - OPERATIONS' or `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' AND `department` like 'DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)' AND `department` like 'DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)' AND `department` like 'DIRECT SELLING - OPERATIONS - (MINDANAO)' AND `department` like 'DIRECT SELLING - OPERATIONS - (VISAYAS)'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadREIMITEMLIST()
        ...
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_reimbursement_list where `reimbursementno` like '%" & txtCONTROL.Text & "%' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("Update tbl_tic_reimbursement set endorsed_approval=@endorsed_approval, endorsed_comment=@endorsed_comment, status=@status where id=@id", cn)
    ...
    Private Sub frmTIC_REIMBURSEMENT_MANAGER_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
