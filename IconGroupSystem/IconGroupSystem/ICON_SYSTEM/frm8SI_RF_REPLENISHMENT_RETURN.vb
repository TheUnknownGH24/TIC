Public Class frm8SI_RF_REPLENISHMENT_RETURN
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_rf_replenishment WHERE `STATUS` = 'RETURNED' AND `rf_no` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_rf_replenishment WHERE employee like '%" & txtNAME.Text & "%' AND `STATUS` = 'RETURNED' AND `rf_no` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_rf_replenishment WHERE `STATUS` = 'RETURNED' AND `rf_no` like '%" & TextBox3.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadRFList()
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_rf_replenishment WHERE `STATUS` = 'RETURNED'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (CENTRAL AND NORTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (NCR AND SOUTH LUZON)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (MINDANAO)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS - (VISAYAS)" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_rf_replenishment WHERE employee like '%" & txtNAME.Text & "%' AND `STATUS` = 'RETURNED'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_8si_rf_replenishment WHERE `STATUS` = 'RETURNED' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%' ", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click_1(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("Update tbl_8si_rf_replenishment set revolving_fund=@revolving_fund, total_liquidation=@total_liquidation, unreplenish=@unreplenish, purpose=@purpose, date_time=@date_time, status=@status where id=@id", cn)
    ...
    Sub DeleteInRFList()
        ...
        cm = New MySqlCommand("DELETE FROM tbl_8si_rf_replenishment_list WHERE `rf_no` like '%" & txtCONTROL.Text & "%'", cn)
    ...
    Private Sub frm8SI_RF_REPLENISHMENT_RETURN_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
