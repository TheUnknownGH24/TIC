...
Public Class frmTIC_PR_MANAGERLIST
    ...
    Private Sub frmTIC_PR_MANAGERLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
