Public Class frmTIC_PAYMENTREQUEST
    ...
    Sub DisplayNO()
        ...
        cn.Open()
        adp = New MySqlDataAdapter("select * from tbl_tic_paymentrequest where transaction_no = '" & txtTRANSACTION.Text & "'", cn)
        dt = New DataTable
        adp.Fill(dt)
    ...
    Private Sub frmTIC_PAYMENTREQUEST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
