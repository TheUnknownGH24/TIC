...
Public Class frmTIC_PO_MODIFYLIST
    ...
    Private Sub frmTIC_PO_MODIFYLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
