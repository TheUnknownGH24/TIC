Public Class frmTIC_CHECKVOUCHER_FUNDTRANSFER
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If txtAMOUNTDUE.Text = "" Then
            ...
            MsgBox("Please Input Amount!", vbOKOnly + vbCritical, "CONFIRMATION")
            Return
        ...
        If txtPARTICULARS.Text = "" Then
            ...
            MsgBox("Please Input Particulars!", vbOKOnly + vbCritical, "CONFIRMATION")
            Return
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            With cm.Parameters
                ...
                .AddWithValue("@reference", txtTRANSACTION.Text)
    ...
    Sub DisplayCVNO()
        ...
        cn.Open()
        adp = New MySqlDataAdapter("select * from tbl_tic_checkvoucher where `reference` = '" & txtTRANSACTION.Text & "'", cn)
        dt = New DataTable
        adp.Fill(dt)
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("PAYMENT TYPE#", sign, Brushes.Black, 50, 210)
    ...
    Private Sub frm8SI_CHECKVOUCHER_CALIQ_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        While dr.Read
            i += 1
            DataGridView2.Rows.Add(dr.Item("id").ToString, dr.Item("supplier_name").ToString)
    ...
    Private Sub DataGridView2_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView2.DoubleClick
        ...
        If txtSUPPLIER.Text = String.Empty Then
            ...
            txtSUPPLIER.Text = DataGridView2.CurrentRow.Cells(1).Value

        ElseIf txtSUPPLIER.Text <> "" And txtPAYEE.Text = String.Empty Then

            txtPAYEE.Text = DataGridView2.CurrentRow.Cells(1).Value
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            txtREFERENCECODE.Enabled = True
            txtSUBREFERENCECODE.Enabled = True

            txtPARTICULARS.Enabled = True

            txtACCTCODE.Enabled = True
            txtACCTTITLE.Enabled = True
            txtACCTDEPCODE.Enabled = True
