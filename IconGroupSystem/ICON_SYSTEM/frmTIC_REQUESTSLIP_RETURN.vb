...
Public Class frmTIC_REQUESTSLIP_RETURN
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("Update tbl_tic_requestslip set date_needed=@date_needed, modified_date=@modified_date, status=@status where id=@id", cn)
            With cm.Parameters
    ...
    Private Sub frmTIC_REQUESTSLIP_RETURN_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
