...
Public Class frmTIC_PR_MANAGER_FORM_FINAL
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_tic_purchasedrequest set purpose=@purpose, MANAGER_APPROVAL=@MANAGER_APPROVAL, manager_comment=@manager_comment where id=@id", cn)
                With cm.Parameters
    ...
    Private Sub txtSEARCHNAME_TextChanged(sender As Object, e As EventArgs) Handles txtSEARCHNAME.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where pr_no like '%" & txtSEARCHNAME.Text & "%' AND `MANAGER_APPROVAL` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE'", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadPRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where `MANAGER_APPROVAL` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub btnPRINT_Click(sender As Object, e As EventArgs) Handles btnPRINT.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_tic_purchasedrequest set purpose=@purpose, MANAGER_APPROVAL=@MANAGER_APPROVAL, manager_comment=@manager_comment, status=@status where id=@id", cn)
                With cm.Parameters
                    .AddWithValue("@id", txtID.Text)
                    .AddWithValue("@purpose", txtREMARKS.Text)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        frmTIC_PR_MANAGER_FORM_VIEW.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text
        frmTIC_PR_MANAGER_FORM_VIEW.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text
        frmTIC_PR_MANAGER_FORM_VIEW.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text

        frmTIC_PR_MANAGER_FORM_VIEW.txtPRNO_1.Text = txtCONTROL.Text
        frmTIC_PR_MANAGER_FORM_VIEW.txtPRNO_2.Text = txtCONTROL.Text
        frmTIC_PR_MANAGER_FORM_VIEW.txtPRNO_3.Text = txtCONTROL.Text

        frmTIC_PR_MANAGER_FORM_VIEW.LoadPURCHASEDList_supplier1_FINAL()
        frmTIC_PR_MANAGER_FORM_VIEW.LoadPURCHASEDList_supplier2_FINAL()
        frmTIC_PR_MANAGER_FORM_VIEW.LoadPURCHASEDList_supplier3_FINAL()

        frmTIC_PR_MANAGER_FORM_VIEW.Supplier_sum()

        frmTIC_PR_MANAGER_FORM_VIEW.StartPosition = FormStartPosition.CenterScreen
        frmTIC_PR_MANAGER_FORM_VIEW.Show()

    End Sub

    Private Sub frmTIC_PR_MANAGER_FORM_FINAL_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
