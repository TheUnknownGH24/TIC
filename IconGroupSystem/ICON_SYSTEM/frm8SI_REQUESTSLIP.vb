...
Public Class frm8SI_REQUESTSLIP
    ...
    Private Sub frm8SI_REQUESTSLIP_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
