Public Class frmWAREHOUSE_LOCATION_TIC
    ...
    Sub LoadPO()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_po_tic", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub txtREFERENCE_TextChanged(sender As Object, e As EventArgs) Handles txtREFERENCE.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_po_tic where `po_no` like '%" & txtREFERENCE.Text & "%'", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Try
            ...
            If MsgBox("Update Delivery Location ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_warehouse_po_tic set location_1=@location_1, location_2=@location_2, location_3=@location_3, location_4=@location_4, location_5=@location_5 where po_no=@po_no", cn)
                With cm.Parameters
    ...
    Private Sub dataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dataGridView1.CellContentClick
        ...
        If colname = "colUPDATE" Then
            cn.Open()
            cm = New MySqlCommand("select * from tbl_warehouse_po_tic where id like '" & dataGridView1.Rows(e.RowIndex).Cells(1).Value.ToString & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read
