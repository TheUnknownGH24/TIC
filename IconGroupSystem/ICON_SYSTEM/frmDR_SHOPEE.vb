...
Public Class frmDR_SHOPEE
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles btnBROWSE.Click
    ...
    Private Sub txtSEARCHNAME_TextChanged(sender As Object, e As EventArgs) Handles txtSEARCHNAME.TextChanged
        ...
        Dim conn As New OleDbConnection(connstring)
        conn.Open()
        Dim cmd As New OleDbCommand("Select * from[" & txtSHEETS.Text & "" & "] where `Order ID` like '%' +@parm1+ '%'", conn)
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles btnCREATE.Click
        ...
        Else
            ...
            For Each row As DataGridViewRow In Me.dataGridView1.Rows
                ...
                If ischecked Then
                    dt2.Rows.Add(row.Cells(13).Value, row.Cells(16).Value, row.Cells(18).Value, row.Cells(19).Value)
                End If
            Next
    ...
    Private Sub dataGridView1_CellContentClick_1(sender As Object, e As DataGridViewCellEventArgs) Handles dataGridView1.CellContentClick
        ...
        txtSO_NO.Text = dataGridView1.CurrentRow.Cells(1).Value
        txtSOLDTO.Text = dataGridView1.CurrentRow.Cells(56).Value
        txtADDRESS.Text = dataGridView1.CurrentRow.Cells(58).Value
    ...
    Sub GetProductCode()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select ", cn)
        dr = cm.ExecuteReader
        While dr.Read
            i += 1
            dataGridView1.Rows.Add(i, dr.Item("id").ToString, dr.Item("dr_no").ToString, dr.Item("sales_orderno").ToString, dr.Item("soldto").ToString, dr.Item("address").ToString, dr.Item("platforms").ToString, dr.Item("note").ToString, dr.Item("product_code").ToString, dr.Item("product_name").ToString, dr.Item("quantity").ToString)
