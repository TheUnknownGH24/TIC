...
Public Class frm8SI_PO_MANAGERLIST
    ...
    Private Sub frm8SI_PO_MANAGERLIST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
