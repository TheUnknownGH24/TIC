Public Class frmTIC_PETTYCASHVOUCHER_MANAGER
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_pettycash where `pcv_no` like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR RELEASE' AND `STATUS` = 'ACTIVE'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_pettycash where `pcv_no` like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR RELEASE' AND `STATUS` = 'ACTIVE' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadPCVList()
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_pettycash where `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR RELEASE' AND `STATUS` = 'ACTIVE' ", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtTYPE.Text = "USER" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_pettycash where `endorsed_approval` = 'FOR APPROVAL' AND `finance_approval` = 'FOR APPROVAL' AND `final_approval` = 'FOR RELEASE' AND `STATUS` = 'ACTIVE' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click_1(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("Update tbl_tic_pettycash set endorsed_approval=@endorsed_approval, endorsed_comment=@endorsed_comment, status=@status where id=@id", cn)
    ...
    Private Sub frmTIC_PETTYCASHVOUCHER_MANAGER_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
