...
Public Class frmTIC_PR_FORM_FINAL
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            'reloadtextPR("Select * from tbl_tic_purchasedrequest where transaction_no='" & txtTRANSACTION.Text & "' ")
            '
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("INSERT into tbl_tic_purchasedrequest (transaction_no, employee, department, date, purpose, supplier_1, supplier_2, supplier_3, date_time, MANAGER_APPROVAL, GM_APPROVAL, COO_APPROVAL, STATUS, manager_comment, gm_comment, coo_comment) values(@transaction_no, @employee, @department, @date, @purpose, @supplier_1, @supplier_2, @supplier_3, @date_time, @MANAGER_APPROVAL, @GM_APPROVAL, @COO_APPROVAL, @STATUS, @manager_comment, @gm_comment, @coo_comment)", cn)
                With cm.Parameters
    ...
    Sub DisplayPR()
        ...
        cn.Open()
        adp = New MySqlDataAdapter("select * from tbl_tic_purchasedrequest where transaction_no = '" & txtTRANSACTION.Text & "' ORDER BY id DESC LIMIT 1", cn)
        dt = New DataTable
        adp.Fill(dt)
    ...
    Sub SavePR_SupplierSelect_1()
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("INSERT into tbl_tic_purchasedrequest_select (pr_no, supplier_name, status) values (@pr_no, @supplier_name, @status)", cn)
    ...
    Private Sub frmTIC_PR_FORM_FINAL_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
