Public Class frmWAREHOUSE_IPR
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("INSERT into tbl_warehouse_ipr (transactionno, date, date_required, requestor, department, purpose, destination, origin, remarks, manager_name, manager_approval, manager_comment, final_name, final_approval, final_comment, date_time, status, request_status) values(@transactionno, @date, @date_required, @requestor, @department, @purpose, @destination, @origin, @remarks, @manager_name, @manager_approval, @manager_comment, @final_name, @final_approval, @final_comment, @date_time, @status, @request_status)", cn)
            With cm.Parameters
            ...
            MsgBox("Inventory Pull-0ut has been Successfully Saved!", vbInformation + vbOKOnly, "CONFIRMATION")
