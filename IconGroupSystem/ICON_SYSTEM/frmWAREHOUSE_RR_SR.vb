Public Class frmWAREHOUSE_RR_SR
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_sr where `sr_no` like '%" & TextBox1.Text & "%' AND `STATUS` = 'ACTIVE' AND `manager_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' ", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadSRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_sr where `STATUS` = 'ACTIVE' AND `manager_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' ", cn)
        dr = cm.ExecuteReader
