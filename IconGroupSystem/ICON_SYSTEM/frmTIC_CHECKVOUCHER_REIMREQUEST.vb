Public Class frmTIC_CHECKVOUCHER_REIMREQUEST
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%' AND `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'APPROVED BY MS.VTY'", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadREIMList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_reimbursement where `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'APPROVED BY MS.VTY'", cn)
        dr = cm.ExecuteReader
    ...
    Sub CV_UPDATE()
        ...
        cn.Open()
        cm = New MySqlCommand("Update tbl_tic_reimbursement set status=@status where id=@id", cn)
    ...
    Private Sub DataGridView2_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView2.CellContentClick
        ...
        If colname = "MANAGER_APPROVAL" Then
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where id like '" & DataGridView2.Rows(e.RowIndex).Cells(1).Value.ToString & "'", cn)
            dr = cm.ExecuteReader
            While dr.Read
                ...
                txtAMOUNTDUE.Text = DataGridView2.Rows(e.RowIndex).Cells(9).Value.ToString

                txtCOMMENT_1.Text = DataGridView2.Rows(e.RowIndex).Cells(10).Value.ToString
                txtCOMMENT_2.Text = DataGridView2.Rows(e.RowIndex).Cells(11).Value.ToString
                txtCOMMENT_3.Text = DataGridView2.Rows(e.RowIndex).Cells(12).Value.ToString
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("REIM#", sign, Brushes.Black, 50, 210)
    ...
    Private Sub frmTIC_CHECKVOUCHER_REIMREQUEST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
