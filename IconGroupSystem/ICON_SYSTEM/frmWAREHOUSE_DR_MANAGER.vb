Public Class frmWAREHOUSE_DR_MANAGER
    ...
    Sub LoadDRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_dr where `supervisor_approval` = 'APPROVED' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_dr where dr_no like '%" & TextBox1.Text & "%' AND `supervisor_approval` = 'APPROVED' AND `final_approval` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Try
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_warehouse_dr set final_name=@final_name, final_approval=@final_approval, final_comment=@final_comment, status=@status where id=@id", cn)
                ...
                With cm.Parameters
                    ...
                    .AddWithValue("@status", "FOR DISPATCH")
    ...
    Sub DispatchUpdate()
        ...
        If txtFINALCODE.Text = "SRS" Then
            ...
            With cm.Parameters
                ...
                .AddWithValue("@request_status", "FOR DISPATCH")
