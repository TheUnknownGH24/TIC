...
Public Class frmTIC_TRACKER_PO
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_purchasedorder where `po_no` like '" & txtREFERENCE.Text & "'", cn)
    ...
    Private Sub txtREFERENCE_TextChanged(sender As Object, e As EventArgs) Handles txtREFERENCE.TextChanged
        ...
        DataGridView2.Rows.Clear()
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_purchasedorder where `pr_no` like '%" & txtREFERENCE.Text & "%'", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub frmTIC_TRACKER_PO_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub txtPRNO_TextChanged(sender As Object, e As EventArgs) Handles txtPRNO.TextChanged
