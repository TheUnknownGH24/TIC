...
Public Class frmTIC_PR_COO_FORM_FINAL
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_tic_purchasedrequest set purpose=@purpose, COO_APPROVAL=@COO_APPROVAL, coo_comment=@coo_comment where id=@id", cn)
                With cm.Parameters
    ...
    Private Sub btnPRINT_Click(sender As Object, e As EventArgs) Handles btnPRINT.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_tic_purchasedrequest set purpose=@purpose, COO_APPROVAL=@COO_APPROVAL, coo_comment=@coo_comment, status=@status where id=@id", cn)
                With cm.Parameters
                    .AddWithValue("@id", txtID.Text)
                    .AddWithValue("@purpose", txtREMARKS.Text)
    ...
    Private Sub btnRETURN_Click(sender As Object, e As EventArgs) Handles btnRETURN.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_tic_purchasedrequest set purpose=@purpose, MANAGER_APPROVAL=@MANAGER_APPROVAL, manager_comment=@manager_comment, GM_APPROVAL=@GM_APPROVAL, gm_comment=@gm_comment, COO_APPROVAL=@COO_APPROVAL, coo_comment=@coo_comment, status=@status where id=@id", cn)
                With cm.Parameters
                    .AddWithValue("@id", txtID.Text)
                    .AddWithValue("@purpose", txtREMARKS.Text)
    ...
    Private Sub DataGridView5_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView5.CellContentClick
        ...
        If colname = "MANAGER_APPROVAL" Then
            ...
            While dr.Read
                ...
                txtMANAGERCOMMENT.Text = DataGridView5.Rows(e.RowIndex).Cells(11).Value.ToString
                txtGMCOMMENT.Text = DataGridView5.Rows(e.RowIndex).Cells(12).Value.ToString
    ...
    Private Sub txtSEARCHNAME_TextChanged(sender As Object, e As EventArgs) Handles txtSEARCHNAME.TextChanged
        ...
        While dr.Read
            i += 1
            DataGridView5.Rows.Add(i, dr.Item("id").ToString, dr.Item("pr_no").ToString, dr.Item("transaction_no").ToString, dr.Item("employee").ToString, dr.Item("department").ToString, dr.Item("date").ToString, dr.Item("purpose").ToString, dr.Item("supplier_1").ToString, dr.Item("supplier_2").ToString, dr.Item("supplier_3").ToString, dr.Item("manager_comment").ToString, dr.Item("gm_comment").ToString)
    ...
    Sub LoadPRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_purchasedrequest where `MANAGER_APPROVAL` = 'APPROVED' and `GM_APPROVAL` = 'APPROVED' and `COO_APPROVAL` = 'FOR APPROVAL' AND `STATUS` = 'ACTIVE' ", cn)
        dr = cm.ExecuteReader
    ...
    Sub Add_Approval_Button()
        ...
        End With
        DataGridView5.Columns.Insert(13, colApproval)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        frmTIC_PR_COO_FORM_VIEW.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text
        frmTIC_PR_COO_FORM_VIEW.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text
        frmTIC_PR_COO_FORM_VIEW.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text

        frmTIC_PR_COO_FORM_VIEW.txtPRNO_1.Text = txtCONTROL.Text
        frmTIC_PR_COO_FORM_VIEW.txtPRNO_2.Text = txtCONTROL.Text
        frmTIC_PR_COO_FORM_VIEW.txtPRNO_3.Text = txtCONTROL.Text

        frmTIC_PR_COO_FORM_VIEW.LoadPURCHASEDList_supplier1_FINAL()
        frmTIC_PR_COO_FORM_VIEW.LoadPURCHASEDList_supplier2_FINAL()
        frmTIC_PR_COO_FORM_VIEW.LoadPURCHASEDList_supplier3_FINAL()

        frmTIC_PR_COO_FORM_VIEW.Supplier_sum()

        frmTIC_PR_COO_FORM_VIEW.StartPosition = FormStartPosition.CenterScreen
        frmTIC_PR_COO_FORM_VIEW.Show()


    End Sub


    Private Sub frmTIC_PR_COO_FORM_FINAL_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
