...
Public Class frm8SI_PR_FORM
    ...
    Private Sub button3_Click(sender As Object, e As EventArgs) Handles button3.Click
        ...
        If txtTOTALUNIT_1.Text = String.Empty Then
    ...
    Private Sub txtUNITPRICE_1_Leave(sender As Object, e As EventArgs) Handles txtUNITPRICE_1.Leave

        txtUNITPRICE_1.Text = CDbl(txtUNITPRICE_1.Text).ToString("#,##0.00")
    ...
    Private Sub txtUNITPRICE_2_Leave(sender As Object, e As EventArgs) Handles txtUNITPRICE_2.Leave

        txtUNITPRICE_2.Text = CDbl(txtUNITPRICE_2.Text).ToString("#,##0.00")
    ...
    Private Sub txtUNITPRICE_3_Leave(sender As Object, e As EventArgs) Handles txtUNITPRICE_3.Leave

        txtUNITPRICE_3.Text = CDbl(txtUNITPRICE_3.Text).ToString("#,##0.00")
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        frm8SI_PR_FORM_FINAL.txtID.Text = txtID.Text
        frm8SI_PR_FORM_FINAL.txtEMPLOYEE.Text = txtEMPLOYEE.Text
        frm8SI_PR_FORM_FINAL.txtDEPARTMENT.Text = txtDEPARTMENT.Text
        frm8SI_PR_FORM_FINAL.txtDATE.Text = txtDATE.Text
        frm8SI_PR_FORM_FINAL.txtTRANSACTION.Text = txtTRANSACTION.Text
        frm8SI_PR_FORM_FINAL.txtREMARKS.Text = txtREMARKS.Text

        frm8SI_PR_FORM_FINAL.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text

        frm8SI_PR_FORM_FINAL.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text

        frm8SI_PR_FORM_FINAL.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text

        frm8SI_PR_FORM_FINAL.txtTOTALCOUNT.Text = txtREQUESTCOUNT.Text - txtPRCOUNT.Text
        ...
        Dim dt_data1 As New DataTable()
        Dim dt_data2 As New DataTable()
        Dim dt_data3 As New DataTable()

        dt_data1.Columns.Add("QUANTITY")
        dt_data1.Columns.Add("UNIT")
        dt_data1.Columns.Add("ITEM_NAME")
        dt_data1.Columns.Add("UNIT_PRICE")
        dt_data1.Columns.Add("VAT_AMOUNT")
        dt_data1.Columns.Add("TOTAL_PRICE")

        dt_data2.Columns.Add("QUANTITY")
        dt_data2.Columns.Add("UNIT")
        dt_data2.Columns.Add("ITEM_NAME")
        dt_data2.Columns.Add("UNIT_PRICE")
        dt_data2.Columns.Add("VAT_AMOUNT")
        dt_data2.Columns.Add("TOTAL_PRICE")

        dt_data3.Columns.Add("QUANTITY")
        dt_data3.Columns.Add("UNIT")
        dt_data3.Columns.Add("ITEM_NAME")
        dt_data3.Columns.Add("UNIT_PRICE")
        dt_data3.Columns.Add("VAT_AMOUNT")
        dt_data3.Columns.Add("TOTAL_PRICE")
        ...
        For Each row_1 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frm8SI_PR_FORM_FINAL.dataGridView1.DataSource = dt_1
        ...
        For Each row_2 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frm8SI_PR_FORM_FINAL.DataGridView2.DataSource = dt_2
        ...
        For Each row_3 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frm8SI_PR_FORM_FINAL.DataGridView3.DataSource = dt_3

        '==============================================================================================================

        For Each row_all As DataGridViewRow In dataGridView1.Rows

            dt_all.Rows.Add(row_all.Cells(0).Value, row_all.Cells(1).Value, row_all.Cells(2).Value, row_all.Cells(3).Value, row_all.Cells(4).Value, row_all.Cells(5).Value, row_all.Cells(6).Value, row_all.Cells(7).Value, row_all.Cells(8).Value, row_all.Cells(9).Value, row_all.Cells(10).Value, row_all.Cells(11).Value, row_all.Cells(12).Value, row_all.Cells(13).Value, row_all.Cells(14).Value, row_all.Cells(18).Value)

        Next
        frm8SI_PR_FORM_FINAL.DataGridView4.DataSource = dt_all

        '==============================================================================================================

        If txtSUPPLIER_1.Text = String.Empty Then

            frm8SI_PR_FORM_FINAL.DataGridView5.Rows.Clear()

        Else

            For Each row_dt_data1 As DataGridViewRow In dataGridView1.Rows

                dt_data1.Rows.Add(row_dt_data1.Cells(0).Value, row_dt_data1.Cells(1).Value, row_dt_data1.Cells(2).Value, row_dt_data1.Cells(4).Value, row_dt_data1.Cells(5).Value, row_dt_data1.Cells(6).Value)

            Next
            frm8SI_PR_FORM_FINAL.DataGridView5.DataSource = dt_data1
        ...
        If txtSUPPLIER_2.Text = String.Empty Then
            ...
            frm8SI_PR_FORM_FINAL.DataGridView6.Rows.Clear()

        Else

            For Each row_dt_data2 As DataGridViewRow In dataGridView1.Rows

                dt_data2.Rows.Add(row_dt_data2.Cells(0).Value, row_dt_data2.Cells(1).Value, row_dt_data2.Cells(2).Value, row_dt_data2.Cells(8).Value, row_dt_data2.Cells(9).Value, row_dt_data2.Cells(10).Value)

            Next
            frm8SI_PR_FORM_FINAL.DataGridView6.DataSource = dt_data2
        ...
        If txtSUPPLIER_3.Text = String.Empty Then
            ...
            frm8SI_PR_FORM_FINAL.DataGridView7.Rows.Clear()

        Else

            For Each row_dt_data3 As DataGridViewRow In dataGridView1.Rows

                dt_data3.Rows.Add(row_dt_data3.Cells(0).Value, row_dt_data3.Cells(1).Value, row_dt_data3.Cells(2).Value, row_dt_data3.Cells(12).Value, row_dt_data3.Cells(13).Value, row_dt_data3.Cells(14).Value)

            Next
            frm8SI_PR_FORM_FINAL.DataGridView7.DataSource = dt_data3

        End If

        '==============================================================================================================

        frm8SI_PR_FORM_FINAL.Supplier_sum()
        frm8SI_PR_FORM_FINAL.Supplier_sum_DATA()
        frm8SI_PR_FORM_FINAL.StartPosition = FormStartPosition.CenterParent
        frm8SI_PR_FORM_FINAL.ShowDialog()
    ...
    Private Sub DataGridView2_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView2.DoubleClick
        ...
        txtITEM.Text = DataGridView2.CurrentRow.Cells(3).Value
        txtUNIT.Text = DataGridView2.CurrentRow.Cells(2).Value

    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click

        With frm8SI_PR_ADDSUPPLIER_1
    ...
    Sub LoadITEM()
        ...
        cn.Open()
        cm = New MySqlCommand("select * from tbl_8si_requestsliplist where `controlno` like '%" & txtTRANSACTION.Text & "%' ", cn)
        dr = cm.ExecuteReader
    ...
    Sub REQUEST_ITEM__COUNT()

        txtREQUESTCOUNT.Text = DataGridView2.RowCount

    End Sub

    Sub PR_ITEM__COUNT()

        txtPRCOUNT.Text = dataGridView1.RowCount
    ...
    Private Sub frm8SI_PR_FORM_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
