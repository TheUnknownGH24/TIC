Public Class frmWAREHOUSE_SRS
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("INSERT into tbl_warehouse_srs (date, transactionno, date_required, requestor, department, purpose, manager_name, manager_approval, manager_comment, final_name, final_approval, final_comment, releaser_name, releaser_approval, releaser_comment, date_time, status, request_status) values(@date, @transactionno, @date_required, @requestor, @department, @purpose, @manager_name, @manager_approval, @manager_comment, @final_name, @final_approval, @final_comment, @releaser_name, @releaser_approval, @releaser_comment, @date_time, @status, @request_status)", cn)
            With cm.Parameters
                ...
                .AddWithValue("@releaser_name", " ")
                .AddWithValue("@releaser_approval", "FOR APPROVAL")
                .AddWithValue("@releaser_comment", " ")
            ...
            MsgBox("Supply Requisition Slip has been Successfully Saved!", vbInformation + vbOKOnly, "CONFIRMATION")
    ...
    Sub DisplaySRS()
        ...
        cn.Open()
        adp = New MySqlDataAdapter("select * from tbl_warehouse_srs where `transactionno` = '" & txtTRANSACTION.Text & "'", cn)
        dt = New DataTable
        adp.Fill(dt)
