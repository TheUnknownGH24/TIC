...
Public Class frm8SI_PR_RETURN_FORM
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        frm8SI_PR_RETURN_FORM_FINAL.txtID.Text = txtID.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtMANAGERCOMMENT.Text = txtMANAGERCOMMENT.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtGMCOMMENT.Text = txtGMCOMMENT.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtID.Text = txtID.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtCONTROL.Text = txtCONTROL.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtEMPLOYEE.Text = txtEMPLOYEE.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtDEPARTMENT.Text = txtDEPARTMENT.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtDATE.Text = txtDATE.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtTRANSACTION.Text = txtTRANSACTION.Text
        frm8SI_PR_RETURN_FORM_FINAL.txtREMARKS.Text = txtREMARKS.Text

        frm8SI_PR_RETURN_FORM_FINAL.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text

        frm8SI_PR_RETURN_FORM_FINAL.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text

        frm8SI_PR_RETURN_FORM_FINAL.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text
        ...
        For Each row_1 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frm8SI_PR_RETURN_FORM_FINAL.dataGridView1.DataSource = dt_1
        ...
        For Each row_2 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frm8SI_PR_RETURN_FORM_FINAL.DataGridView2.DataSource = dt_2
        ...
        For Each row_3 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frm8SI_PR_RETURN_FORM_FINAL.DataGridView3.DataSource = dt_3
        ...
        Next
        frm8SI_PR_RETURN_FORM_FINAL.DataGridView4.DataSource = dt_all


        frm8SI_PR_RETURN_FORM_FINAL.Supplier_sum()
        frm8SI_PR_RETURN_FORM_FINAL.StartPosition = FormStartPosition.CenterParent
        frm8SI_PR_RETURN_FORM_FINAL.ShowDialog()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        With frm8SI_PR_MODIFY_ADDSUPPLIER_1
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        With frm8SI_PR_MODIFY_ADDSUPPLIER_2
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        With frm8SI_PR_MODIFY_ADDSUPPLIER_3
    ...
    Private Sub frm8SI_PR_RETURN_FORM_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
