...
Public Class frmTIC_PR_FORM
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        frmTIC_PR_FORM_FINAL.txtID.Text = txtID.Text
        frmTIC_PR_FORM_FINAL.txtEMPLOYEE.Text = txtEMPLOYEE.Text
        frmTIC_PR_FORM_FINAL.txtDEPARTMENT.Text = txtDEPARTMENT.Text
        frmTIC_PR_FORM_FINAL.txtDATE.Text = txtDATE.Text
        frmTIC_PR_FORM_FINAL.txtTRANSACTION.Text = txtTRANSACTION.Text
        frmTIC_PR_FORM_FINAL.txtREMARKS.Text = txtREMARKS.Text

        frmTIC_PR_FORM_FINAL.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text

        frmTIC_PR_FORM_FINAL.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text

        frmTIC_PR_FORM_FINAL.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text
        ...
        For Each row_1 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frmTIC_PR_FORM_FINAL.dataGridView1.DataSource = dt_1
        ...
        For Each row_2 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frmTIC_PR_FORM_FINAL.DataGridView2.DataSource = dt_2
        ...
        For Each row_3 As DataGridViewRow In dataGridView1.Rows
            ...
            End If
        Next
        frmTIC_PR_FORM_FINAL.DataGridView3.DataSource = dt_3
        ...
        Next
        frmTIC_PR_FORM_FINAL.DataGridView4.DataSource = dt_all

        '==============================================================================================================

        If txtSUPPLIER_1.Text = String.Empty Then

            frmTIC_PR_FORM_FINAL.DataGridView5.Rows.Clear()
        ...
        Else
            ...
            Next
            frmTIC_PR_FORM_FINAL.DataGridView5.DataSource = dt_data1
        ...
        If txtSUPPLIER_2.Text = String.Empty Then
            ...
            frmTIC_PR_FORM_FINAL.DataGridView6.Rows.Clear()
        ...
        Else
            ...
            Next
            frmTIC_PR_FORM_FINAL.DataGridView6.DataSource = dt_data2
        ...
        If txtSUPPLIER_3.Text = String.Empty Then
            ...
            frmTIC_PR_FORM_FINAL.DataGridView7.Rows.Clear()
        ...
        Else
            ...
            Next
            frmTIC_PR_FORM_FINAL.DataGridView7.DataSource = dt_data3

        End If

        '==============================================================================================================

        frmTIC_PR_FORM_FINAL.Supplier_sum()
        frmTIC_PR_FORM_FINAL.Supplier_sum_DATA()
        frmTIC_PR_FORM_FINAL.StartPosition = FormStartPosition.CenterParent
        frmTIC_PR_FORM_FINAL.ShowDialog()
    ...
    Private Sub frmTIC_PR_FORM_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
