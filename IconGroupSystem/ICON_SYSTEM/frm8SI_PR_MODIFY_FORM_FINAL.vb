...
Public Class frm8SI_PR_MODIFY_FORM_FINAL
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_8si_purchasedrequest set purpose=@purpose, modified_data_time=@modified_data_time where id=@id", cn)
                With cm.Parameters
    ...
    Private Sub frm8SI_PR_MODIFY_FORM_FINAL_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
