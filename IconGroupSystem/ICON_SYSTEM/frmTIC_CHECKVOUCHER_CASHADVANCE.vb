Public Class frmTIC_CHECKVOUCHER_CASHADVANCE
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("CA#", sign, Brushes.Black, 50, 210)
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_cashadvance where ca_no like '%" & TextBox1.Text & "%' AND `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'APPROVED BY MS.VTY'", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadCAList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_tic_cashadvance where `endorsed_approval` = 'APPROVED' AND `finance_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'APPROVED BY MS.VTY' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub DataGridView2_CellContentClick_1(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView2.CellContentClick
        ...
        If colname = "MANAGER_APPROVAL" Then
            ...
            While dr.Read
                ...
                txtPARTICULARS.Text = DataGridView2.Rows(e.RowIndex).Cells(9).Value.ToString

                txtAMOUNTDUE.Text = DataGridView2.Rows(e.RowIndex).Cells(10).Value.ToString

                txtCOMMENT_1.Text = DataGridView2.Rows(e.RowIndex).Cells(11).Value.ToString
                txtCOMMENT_2.Text = DataGridView2.Rows(e.RowIndex).Cells(12).Value.ToString
                txtCOMMENT_3.Text = DataGridView2.Rows(e.RowIndex).Cells(13).Value.ToString
    ...
    Private Sub frmTIC_CHECKVOUCHER_CASHADVANCE_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
