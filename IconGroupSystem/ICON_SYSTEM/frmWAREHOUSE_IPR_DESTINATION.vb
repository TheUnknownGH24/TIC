Public Class frmWAREHOUSE_IPR_DESTINATION
    ...
    Sub LoadIPRList()
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_ipr where `manager_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'ACTIVE' AND `destination` = '' ", cn)
        dr = cm.ExecuteReader
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        ...
        Dim i As Integer
        cn.Open()
        cm = New MySqlCommand("select * from tbl_warehouse_ipr where ipr_no like '%" & TextBox1.Text & "%' AND `manager_approval` = 'APPROVED' AND `final_approval` = 'APPROVED' AND `STATUS` = 'ACTIVE' AND `destination` = '' ", cn)
        dr = cm.ExecuteReader
    ...
    Sub LoadWarehouse()
        ...
        While dr.Read
            ...
            txtDESTINATION.Items.Add(dr.Item("warehouse_name").ToString)
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        Try
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                cn.Open()
                cm = New MySqlCommand("Update tbl_warehouse_ipr set destination=@destination where id=@id", cn)

                With cm.Parameters

                    .AddWithValue("@id", txtID.Text)

                    .AddWithValue("@destination", txtDESTINATION.Text)
                ...
                MsgBox("Destination has been Successfully Update!", vbInformation + vbOKOnly, "CONFIRMATION")
