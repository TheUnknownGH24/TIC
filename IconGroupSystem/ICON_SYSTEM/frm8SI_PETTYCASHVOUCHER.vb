Public Class frm8SI_PETTYCASHVOUCHER
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            cn.Open()
            cm = New MySqlCommand("INSERT into tbl_8si_pettycash (transaction_no, date, employee, department, depcode, date_needed, purpose, amount, endorsed_approval, finance_approval, final_approval, date_time, status, endorsed_comment, finance_comment, final_comment) values(@transaction_no, @date, @employee, @department, @depcode, @date_needed, @purpose, @amount, @endorsed_approval, @finance_approval, @final_approval, @date_time, @status, @endorsed_comment, @finance_comment, @final_comment)", cn)
            With cm.Parameters
    ...
    Sub DisplayPCVNO()
        ...
        cn.Open()
        adp = New MySqlDataAdapter("select * from tbl_8si_pettycash where transaction_no = '" & txtTRANSACTION.Text & "'", cn)
        dt = New DataTable
        adp.Fill(dt)
    ...
    Private Sub frm8SI_PETTYCASHVOUCHER_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
