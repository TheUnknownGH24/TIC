...
Public Class frmMANAGER_PO_APPROVAL
        ...
        Else
            ...
            If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                With cm.Parameters
                    ...
                    .AddWithValue("@manager_comment", txtREMARKS.Text & " - " & DateTimePicker1.Value)
