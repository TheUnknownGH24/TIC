...
Public Class frm8SI_PAYMENTREQUEST
    ...
    Sub LoadPaymentType()
        ...
        cn.Open()
        cm = New MySqlCommand("select * from tblpaymentrequest_type", cn)
        dr = cm.ExecuteReader
        While dr.Read

            txtPAYMENTTYPE.Items.Add(dr.Item("payment_type").ToString)
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        If MsgBox("Do you want to Proceed ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
            ...
            txtMODEPAYMENT.Enabled = False
            txtMODERELEASE.Enabled = False
            txtOTHERS.Enabled = False
    ...
    Sub DisplayNO()
        ...
        cn.Open()
        adp = New MySqlDataAdapter("select * from tbl_8si_paymentrequest where transaction_no = '" & txtTRANSACTION.Text & "'", cn)
        dt = New DataTable
        adp.Fill(dt)
    ...
    Private Sub btnRESET_Click(sender As Object, e As EventArgs) Handles btnRESET.Click
        ...
        Try
            If MsgBox("Do you want to Reset ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                txtMODEPAYMENT.SelectedIndex = -1
                txtMODERELEASE.SelectedIndex = -1

                txtOTHERS.Text = ""

                txtSUPPLIER_SELECT.Text = ""
                txtACCOUNTNAME.Text = ""
                txtACCOUNTNO.Text = ""
                txtBANKNAME.Text = ""
                ...
                txtMODEPAYMENT.Enabled = True
                txtMODERELEASE.Enabled = True
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("REFERENCE", sign, Brushes.Black, 500, 230)
        ...
        e.Graphics.DrawString("SUB REFERENCE", sign, Brushes.Black, 50, 230)
    ...
    Private Sub frm8SI_PAYMENTREQUEST_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
