...
Public Class frmGM_PR_APPROVAL
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Try
            If MsgBox("Do you want to Exit ?", vbYesNo + vbQuestion, "CONFIRMATION") = vbYes Then
                ...
                frmGM_PR_APPROVAL_LIST.LoadPRList()
                Me.Dispose()
    ...
    Private Sub btnSAVE_Click(sender As Object, e As EventArgs) Handles btnSAVE.Click
        ...
        frmGM_PR_APPROVAL_FINAL.txtID.Text = txtID.Text
        frmGM_PR_APPROVAL_FINAL.txtCONTROL.Text = txtCONTROL.Text
        frmGM_PR_APPROVAL_FINAL.txtEMPLOYEE.Text = txtEMPLOYEE.Text
        frmGM_PR_APPROVAL_FINAL.txtDEPARTMENT.Text = txtDEPARTMENT.Text
        frmGM_PR_APPROVAL_FINAL.txtDATE.Text = txtDATE.Text
        frmGM_PR_APPROVAL_FINAL.txtTRANSACTION.Text = txtTRANSACTION.Text
        frmGM_PR_APPROVAL_FINAL.txtREMARKS.Text = txtREMARKS.Text

        frmGM_PR_APPROVAL_FINAL.txtSUPPLIER_1.Text = txtSUPPLIER_1.Text

        frmGM_PR_APPROVAL_FINAL.txtSUPPLIER_2.Text = txtSUPPLIER_2.Text

        frmGM_PR_APPROVAL_FINAL.txtSUPPLIER_3.Text = txtSUPPLIER_3.Text

        frmGM_PR_APPROVAL_FINAL.LoadSupplier_1()
        frmGM_PR_APPROVAL_FINAL.LoadSupplier_2()
        frmGM_PR_APPROVAL_FINAL.LoadSupplier_3()

        frmGM_PR_APPROVAL_FINAL.StartPosition = FormStartPosition.CenterScreen
        frmGM_PR_APPROVAL_FINAL.ShowDialog()
