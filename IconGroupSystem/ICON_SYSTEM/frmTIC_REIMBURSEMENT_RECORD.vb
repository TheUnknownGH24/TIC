Public Class frmTIC_REIMBURSEMENT_RECORD
    ...
    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox3.TextChanged
        ...
        If txtTYPE.Text = "ADMINISTRATOR" Or txtDEPARTMENTDATA.Text = "FINANCE DEPARTMENT" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtNAME.Text = "JENNALYN VALLE ALFABETE" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `reimbursementno` like '%" & TextBox3.Text & "%' AND `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where employee like '%" & txtNAME.Text & "%' AND `reimbursementno` like '%" & TextBox3.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Sub LoadREIMList()
        ...
        ElseIf txtNAME.Text = "JENNALYN VALLE ALFABETE" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where `department` like '%" & txtDEPARTMENTDATA.Text & "%'", cn)
            dr = cm.ExecuteReader
        ...
        ElseIf txtDEPARTMENTDATA.Text = "DIRECT SELLING - OPERATIONS" Or txtDEPARTMENTDATA.Text = "DIRECT SELLING - BUSINESS DEV" Then
            ...
            Dim i As Integer
            cn.Open()
            cm = New MySqlCommand("select * from tbl_tic_reimbursement where employee like '%" & txtNAME.Text & "%'", cn)
            dr = cm.ExecuteReader
    ...
    Private Sub frmTIC_REIMBURSEMENT_RECORD_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
